...
1. **Open the App**: Launch the website in your browser.
2. **Upload Chart**: Take a screenshot of your trading chart (from TradingView or other platforms) and upload it.
3. **Analyze**: Click the "Analyze" button.
4. **Get Results**: The AI will show the Fibonacci lines on your image and give you a short strategy report.
